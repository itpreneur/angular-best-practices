...
//don't import the whole rxjs module as it takes up a lot of spaces
...
export class UserRepositoryService {
  ...
  saveUser(user): Observable<any> {
    ...
    // possible mutation only if user is being assigned after assigning it to this.currentuser
    //this.currentUser = user;

    //good practice immutability
    this.currentUser = Object.assign({}, this.currentUser, { classes: user.classes || [] });
